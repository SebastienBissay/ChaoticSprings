...
public final class Parameters {
    ...
    public static final int NUMBER_OF_SPRINGS = 5;
    public static final float DELTA_T = 100;
    public static final int MAX_ITERATIONS = 10000;
    public static final float SPEED_LOW_THRESHOLD = 0.001f;
    public static final int OUTER_MARGIN = 50;
    public static final float DAMPENING = .1f;
